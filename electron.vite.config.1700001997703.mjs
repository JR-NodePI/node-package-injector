...
var package_default = {
  ...
  repository: "https://github.com/JR-NodePI/node-package-injector",
  ...
  scripts: {
    ...
    icons: "electron-icon-builder --input=./src/renderer/src/assets/logo-1024x1024.png --output=./build/public",
